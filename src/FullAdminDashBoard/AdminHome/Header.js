...
import logo from "../Images/Healthcare.jpg";
...
const Header = () => {
  return (
    <>
    <div>
      <div className={`container-fluid ${modulecss.topnav} text-bg-success  `}>
        <div className="row">
      ...
      <nav className={`navbar navbar-expand-md  text-bg-info  sticky-top top-0  `}>
